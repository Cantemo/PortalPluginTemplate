...
sudo mkdir -p $PORTAL_ROOT/portal_themes/sand/templates/plugins/$PLUGIN_NAME

sudo cp *.py $PORTAL_ROOT/portal/plugins/$PLUGIN_NAME
sudo cp templates/* $PORTAL_ROOT/portal_themes/sand/templates/plugins/$PLUGIN_NAME
